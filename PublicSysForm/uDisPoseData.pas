...
function TLuDisPoseData.InputData_Begintrans: Boolean;
begin
      Result:=False;
      Sw1.Start;Sw2.Start;
      //ShowMessage(Gzmbh);
...
function TLuDisPoseData.InputData_CommitTrans(var elapsedtime:string): Boolean;
var
  iSqi:string;
...
procedure TLuDisPoseData.ConnectInputDataLink;
begin
...
procedure TLuDisPoseData.ConnectInputFootageLink;
begin
...
procedure TLuDisPoseData.ConnectRealFootLink;
begin
...
constructor TLuDisPoseData.Create(uDM:TMyDataModule);
begin
      inherited  Create;
      FinDataModule:=uDM;
...
function TLuDisPoseData.DatetimeToFootage(Gzmbh: integer; Dt: TdateTime;
  Str: String): double;
var
  sql:string;
  Df,UF,MF:double;
...
procedure TLuDisPoseData.FootageTimeTimer(Sender: Tobject);
begin
...
function TLuDisPoseData.FootageToDate(Gzmbh: integer; FG: double;
...
function TLuDisPoseData.GetForcastResult(GzmList:TStringlist) : string;
var
   MyXml:TNativeXml;
   RootNode :TXmlNode;
   ChildRoot:TXmlNode;
...
function TLuDisPoseData.GetGzmBh(Value: String): String;
var
  ExDataSet1:TMyDataSet;
begin
      ExDataSet1:=TMyDataSet.Create(nil);
...
function TLuDisPoseData.GetGzmNameS: String;
 Var
   NameS:String;
   ExDataSet1:TMyDataSet;
begin
...
function TLuDisPoseData.GetHistoryResult(Gzmid:integer; StartTime,  StopTime: TDateTime): string;
var
   MyXml:TNativeXml;
   RootNode :TXmlNode;
   ChildRoot:TXmlNode;
...
function TLuDisPoseData.GetInputDataMaxDatetime(Mineid,Gzmbh:integer): TDateTime;
Var
...
procedure TLuDisPoseData.inFinishedE(TotalNumber, supbh: integer;
...
function  TLuDisPoseData.InPutdata(supportbh: integer; Dt: String; V1, v2, V3,
...
function TLuDisPoseData.InputFootage(uGBh:string;tDay: Tdatetime; DownDayFootage,
...
function TLuDisPoseData.InputFootSelectWorkFaceid(Mineid: integer;
...
function TLuDisPoseData.InputFootSelKuangjingId(KuangjingName: String): integer;
begin
...
procedure TLuDisPoseData.InputTimeTimer(Sender: Tobject);
var
  elp:string;
begin
...
function TLuDisPoseData.InsertAllWorkFaceTypeData(FirstType: integer; FirstDataTopLine: Double;
...
function TLuDisPoseData.InsertGzmDataTypeValue(Gzmid, Dataid, DataType: integer;
...
procedure TLuDisPoseData.InsetSql(Sql: string);
var
 ExCommand1:TMyCommand;
begin
      ExCommand1:=TMyCommand.Create(nil);
...
function TLuDisPoseData.ReadiniDataNeverDisCTime: Integer;
Var
  Value:integer;
begin
      if  not assigned(fReadini) then
...
function TLuDisPoseData.RealFootAge_Begintrans: Boolean;
begin
      Result:=False;
...
function TLuDisPoseData.RealFootAge_CommitTrans: Boolean;
var
  iSqi:string;
begin
      Result:=False;
...
function TLuDisPoseData.RealSelectWorkFaceid(Mineid: integer;
  WorkFaceName: String): integer;
begin
    Result:=-1;
    try
...
function TLuDisPoseData.RealSelKuangjingId(KuangjingName: String): integer;
begin
    KuangjingName:=UpperCase(KuangjingName);
    Result:=-1;
    try
...
function TLuDisPoseData.RealTimeFootAge(gzmid, supportbh: Integer;
...
procedure TLuDisPoseData.RefreshProcessFlag;
var
  FGzm:String;
  ExDataSet1:TMyDataSet;
  ExCommand1:TMyCommand;
...
function TLuDisPoseData.SaveIniFile(sData, sIp, sUser, SPw,
...
function TLuDisPoseData.SelectBasicRecordNumber(MyConn:TMySqlConnection;FGzm: String; var MinSupBh,
...
function TLuDisPoseData.SelectBasicSupportExsit(FGzm: String;
...
function TLuDisPoseData.SelectGzmDataTypeExsit(Gzmid, Dataid, DataType:Integer;Stime:TdateTime): Boolean;
var
  Minus:Double;
  sql:String;
begin
...
function TLuDisPoseData.SelectBasicDataCount(GzmBh:string): Boolean;
begin
   Result:=true;
...
function TLuDisPoseData.SelectProcessRecorderUsed(FGzm: String;
  supbh: integer): Boolean;
Var
  sql:string;
   ExDataSet1:TMyDataSet;
...
function TLuDisPoseData.SelectStokeData(Gzmbh: String): Boolean;
begin
    Result:=true;
...
function TLuDisPoseData.SelectWorkFaceid(Mineid: integer;
  WorkFaceName: String): integer;
begin
    Result:=-1;
    try
...
function TLuDisPoseData.SelKuangjingId(KuangjingName: String): integer;
begin
  Result:=-1;
   KuangjingName:=UpperCase(KuangjingName);
  try
...
procedure TLuDisPoseData.SetAppointFootageStop(Value: boolean);
begin
      AppointFootageStop:=Value;
end;

procedure TLuDisPoseData.SetDateNeverDiscontime(Value: integer);
begin
...
procedure TLuDisPoseData.SetFirstProcessStop(Value: Boolean);
begin
      FirstProcessStop:=Value;
end;

procedure TLuDisPoseData.SetFourthProcessStop(Value: boolean);
begin
      FourthProcessStop:=Value;
end;

procedure TLuDisPoseData.setGzmbm(Bh: String);
begin
       uDisPoseGzmBh:=bh;
end;


procedure TLuDisPoseData.SetmaxValuetopLine(V1, V2, V3, V4: double);
begin
...
procedure TLuDisPoseData.SetSecondProcessStop(Value: Boolean);
begin
        SecondProcessStop:=Value;
end;


procedure TLuDisPoseData.SetThirdProcessStop(Value: boolean);
begin
       ThirdProcessStop:=Value;
end;

function TLuDisPoseData.SplitWorkFaceDataType(Gzmid,FirstType: integer;
