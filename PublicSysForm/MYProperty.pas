...
begin
    FinBUC:=inBuc;
    FListDropString:=TStringList.Create ;
...
begin
  ...
  if C2 <7 then  exit;
    ...
    if (lowerCase(CompentType)='list') then   begin
        Str_Temp:=FinBUC.FromStringGetFieldStr(NameClass,FInputString);
