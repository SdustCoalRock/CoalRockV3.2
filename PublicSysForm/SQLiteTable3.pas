...
type
  ...
  private
    ...
    fColTypes: TList;
    fRow: cardinal;
    function GetFields(I: cardinal): RawByteString;
    function GetEOF: boolean;
    function GetBOF: boolean;
    function GetColumns(I: integer): string;
    function GetFieldByName(FieldName: string): RawByteString;
  ...
  public
    ...
    function FieldAsString(I: cardinal): RawByteString;
    function FieldAsDouble(I: cardinal): double;
    function Next: boolean;
    function Previous: boolean;
    property EOF: boolean read GetEOF;
    property BOF: boolean read GetBOF;
    property Fields[I: cardinal]: RawByteString read GetFields;
    property FieldByName[FieldName: string]: RawByteString read GetFieldByName;
...
var
  ...
  thisStringValue: PRawByteString;
...
function TSQLiteTable.GetFieldByName(FieldName: string): RawByteString;
begin
...
function TSQLiteTable.GetFields(I: cardinal): RawByteString;
var
  thisvalue: PRawByteString;
  thistype: integer;
begin
  Result := '';
  if EOF then
...
function TSqliteTable.FieldAsString(I: cardinal): RawByteString;
begin
  if EOF then
    raise ESqliteException.Create('Table is at End of File');
  if (self.fResults[(self.frow * self.fColCount) + I] = nil) then
