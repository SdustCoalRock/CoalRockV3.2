...
begin
   OpenSelectResult(ExHandle,'查询结果',Runsql,Exwid,Exhid);
end;
...
begin
      ...
      UsedFieldGrid.ColWidths[0]:=30;    UsedFieldGrid.Cells[0,0]:='序号';
      UsedFieldGrid.ColWidths[1]:=100;   UsedFieldGrid.Cells[1,0]:='字段说明';
      UsedFieldGrid.ColWidths[2]:=100;   UsedFieldGrid.Cells[2,0]:='字段标识';
      //
      FillFieldName;
      //
