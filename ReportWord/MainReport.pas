...
var
  Pstr:string;
begin
   Pstr:='如果你想生成矿压观测报告，可能需要30分钟左右的时间!如果确认，点击按钮后，'+
              '系统将进入后台矿压报告绘制,在矿压报告生成过程中，请不要打开word编辑其他文档，否则会出现排版错误，请牢记！'  ;
   Memo1.Clear ;
...
begin
    if RadioGroup1.ItemIndex =0 then   begin //隐藏界面显示方式
       Hide ;
    end else begin
       self.Width :=1100;
       self.Height:=650;
