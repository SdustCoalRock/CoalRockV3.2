...
uses
  ...
  uWorkSupWeightUnit in 'uFrom\uWorkSupWeightUnit.pas' {FormSupWeight},
  SupportSubject in 'uFrom\SupportSubject.pas' {Form_Subject},
  VMProtectSDK in '..\PublicSysForm\VMProtectSDK.pas',
